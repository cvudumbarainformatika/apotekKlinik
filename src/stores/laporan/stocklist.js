...
export const useStockListStore = defineStore('stock-list-store', {
  state: () => ({
    items: [],
    params: {
      q: '',
  ...
  actions: {
    ...
    async fetchData(extraParams = {}) {
      ...
      try {
        ...
        const res = await api.get('/api/v1/transactions/stok/get-list', { params })
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useStockListStore, import.meta.hot))

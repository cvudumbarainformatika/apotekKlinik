    ...
    <template #default>
      ...
      <div v-show="activeView === 'view2'" id="printArea2" class="w-[210mm] h-[148mm] bg-white text-black mx-auto p-4 print-a5">
        <div class="">
         ...
         <div class="w-ful mt-3 text-sm"> Obat mengandung prekursor farmasi tersebut akan digunakan untuk memenuhi kebutuhan
            :</div>
          <!-- Totals & Notes -->
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="kiri">
...
const printArea1 = ref(null)
const printArea2 = ref(null)
const printArea3 = ref(null)

      ...
      <u-col flex1 class="w-full" gap="gap-1">
        <u-row flex1 class="w-full pt-1">
          <u-row flex1 class="w-full">
            ...
            <div class="pl-4 font-bold">Expired: {{ formatDateIndo(item?.tgl_exprd) }}</div>
          </u-row>
          <u-row class="">
        ...
        <u-row flex1 class="w-full pt-0 pb-1">
          <u-row flex1 class="w-full">
            <div class="w-full">
              <u-grid cols="11">
                <u-row class="col-span-3">
                  <span >No Penerimaan : {{ item?.nopenerimaan }}</span>
                </u-row>

                <u-row class="col-span-2">
                  <span class="font-small">No Batch : {{ item?.nobatch }}</span>
                </u-row>
                <u-row class="col-span-2">
                  <span class="font-small">Volume : 1 {{ item?.satuan_b }} isi {{ item?.isi }} {{ item?.satuan_k }}
                  </span>
                </u-row>

                <u-row class="col-span-2">
                  <span class="font-small">Harga Resep : {{ formatRpkoma(item?.barang?.harga_jual_resep_k) }}</span>
                </u-row>
                
                <u-row class="col-span-2">
                  <span class="font-small">Harga Umum : {{ formatRpkoma(item?.barang?.harga_jual_biasa_k) }}</span>
                </u-row>
              </u-grid>
            </div>
